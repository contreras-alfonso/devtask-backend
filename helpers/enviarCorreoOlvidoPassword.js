    ...
    const message = {
        ...
        * {
        ...
        <table id="u_content_heading_3" style="font-family:'Raleway',sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
          ...
          <h1 class="v-text-align v-font-size" style="margin: 0px; line-height: 140%; text-align: center; word-wrap: break-word; font-size: 22px; font-weight: 400;"><strong>Recupera tu acceso en upTask</strong></h1>
        ...
        <table id="u_content_heading_2" style="font-family:'Raleway',sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
          ...
          <h1 class="v-text-align v-font-size" style="margin: 0px; color: #5c5c5c; line-height: 140%; text-align: center; word-wrap: break-word; font-size: 14px; font-weight: 400;">Por favor, recupera tu cuenta, dando clic al boton.</h1>
        ...
        <table id="u_content_heading_4" style="font-family:'Raleway',sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
          ...
          <h1 class="v-text-align v-font-size" style="margin: 0px; line-height: 140%; text-align: left; word-wrap: break-word; font-size: 20px; font-weight: 400;"><strong>Subject: Recuperación de password</strong></h1>
        ...
        <p style="line-height: 140%;">Este mensaje es para confirmar que has solicitado la recuperación de tu cuenta en nuestro servicio. Por favor, completa el proceso haciendo clic en el botón de abajo.
        </p>
        <p style="line-height: 140%;"> </p>
        <p style="line-height: 140%;">Si no has solicitado la recuperación de tu cuenta en nuestro servicio o no reconoces esta actividad, por favor ignora este mensaje.
        </p>
        <p style="line-height: 140%;"> </p>
        ...
        <p style="line-height: 140%; font-weight: bolder;">UpTask</p>
          </div>
        ...
        <div class="v-text-align" align="center">
          <!--[if mso]><v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" href="https://unlayer.com/templates" style="height:37px; v-text-anchor:middle; width:155px;" arcsize="11%"  stroke="f" fillcolor="#316b94"><w:anchorlock/><center style="color:#FFFFFF;"><![endif]-->
            <a href="${process.env.FRONTEND_URL}/olvide-password/${token}" target="_blank" class="v-button v-size-width v-font-size" style="box-sizing: border-box;display: inline-block;text-decoration: none;-webkit-text-size-adjust: none;text-align: center;color: #FFFFFF; background-color: #316b94; border-radius: 4px;-webkit-border-radius: 4px; -moz-border-radius: 4px; width:auto; max-width:100%; overflow-wrap: break-word; word-break: break-word; word-wrap:break-word; mso-border-alt: none;font-size: 14px;">
              <span style="display:block;padding:10px 20px;line-height:120%;"><span style="line-height: 16.8px;">Recuperar cuenta</span></span>
            </a>
...
export default enviarCorreoOlvidoPassword